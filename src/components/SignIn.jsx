...
export default function SignIn() {
    ...
    const validateInput = (event) => {
        ...
        if (target === usernameRef.current) {
            ...
            usernameRuleRef.current.classList.remove("animate__animated", "animate__headShake");
            void usernameRuleRef.current.offsetWidth;
        ...
        if (signInButtonRef.current) {
            signInButtonRef.current.disabled = !newAllRight;
            signInButtonRef.current.classList.toggle("enabled", newAllRight);
            signInButtonRef.current.style.backgroundColor = newAllRight ? "#2563eb" : "#ff3c00";
            signInButtonRef.current.style.cursor = newAllRight ? "pointer" : "not-allowed";
        }
    ...
    return (
        <>
            ...
            <br />
            <fieldset id="signIn">
                <form id="signInForm" ref={formRef}>
                    <div id="content1">
